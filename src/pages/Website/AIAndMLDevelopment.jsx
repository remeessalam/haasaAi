...
const AIAndMLDevelopment = () => {
  const prev = allServices[1];
  const next = allServices[3];
  return (
    <div className="flex flex-col gap-10">
      ...
      <div className="flex flex-col gap-4">
        ...
        <p data-aos="fade-up" className="description">
          ...
          AI Company, we are at the forefront of this revolution, leveraging AI
          and ML to develop intelligent solutions that empower businesses,
          enhance operational efficiency, and create personalized experiences
          for users. Our commitment to harnessing the power of data and advanced
          algorithms positions us as a leader in the field of AI and ML
          development.
        </p>
      ...
      <p>
        At AI Company, we are not only focused on the present but also on the

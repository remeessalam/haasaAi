...
const AICallingDevelopment = () => {
  const prev = allServices[12];
  const next = allServices[0];
  const servicedetails = allServices[13];
  return (
      ...
      <div className="grid lg:grid-cols-1 gap-7">
        <div className="h-full w-full">
          <img
            ...
            className="h-full max-h-[20rem] w-full lg:max-h-[70vh] object-cover rounded-md"
            alt="app development"
          />
        </div>
        <div className="flex flex-col gap-4">
...
export default AICallingDevelopment;

...
const localBusinessSchema = {
  ...
  name: "HAASA AI",
  description:
    "HAASA AI is a globally recognized leader in delivering cutting-edge technology solutions including AI, Machine Learning, Blockchain, and Cloud Computing.",
...
const Home = () => {
  return (
    <>
      <Helmet>
        <title>
          HAASA AI - Leading AI & Technology Solutions Provider | Custom
          Software Development
        </title>
        <meta
          name="description"
          content="HAASA AI offers cutting-edge AI, Machine Learning, and Blockchain solutions. Transform your business with our custom software development and technology consulting services."
        />
        <meta
          name="keywords"
        ...
        <meta
          property="og:title"
          content="HAASA AI - Leading AI & Technology Solutions Provider"
        />
        <meta
          property="og:description"
          content="Transform your business with cutting-edge AI, Machine Learning, and Blockchain solutions from HAASA AI."
        />

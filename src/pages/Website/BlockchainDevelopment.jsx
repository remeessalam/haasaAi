...
const BlockchainDevelopment = () => {
  const prev = allServices[2];
  const next = allServices[4];
  return (
    <div className="flex flex-col gap-10">
      ...
      <div className="flex flex-col gap-4">
        ...
        <p data-aos="fade-up" className="description">
          ...
          offering unmatched transparency, security, and efficiency. At AI
          Company, we specialize in providing comprehensive blockchain
          development services tailored to meet the unique needs of businesses
          across industries. From secure smart contracts to decentralized
          applications, our solutions empower organizations to optimize
          operations, mitigate risks, and drive innovation.
        </p>
        ...
        <p data-aos="fade-up" className="description">
          ...
          such as tokenization and decentralized finance. At AI Company, we
          guide organizations through adopting blockchain technologies, ensuring
          they are not only prepared for the future but are at the forefront of
      ...
      <p>
        At AI Company, we harness the power of blockchain to help businesses
